...
class LTIPayloadMaker
{
    ...
    public static function makePayload(Activity $assignment, $endpoint = 'https://www.test.com/test', $resourceLink = null, $student = null, $otherData = [])
    {
        /**
         * Notes
